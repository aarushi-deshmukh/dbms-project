...
class ProductUpdateSerializer(serializers.ModelSerializer):
    """
    Partial update serializer for seller product edits.
...
class BuyerProfileUpdateSerializer(serializers.Serializer):
    """Partial update for buyer profile. All fields optional."""
...
class SellerProfileUpdateSerializer(serializers.Serializer):
    """Partial update for seller profile. All fields optional."""
